...
public class Example extends Object {
	...
	public static void main(String[] arguments) {
		...
		// Model aModel = new Model(aFile);
		ForestModel forestModel = new ForestModel();
		ForestController forestController = new ForestController();
		ForestView forestView = new ForestView(aFile);

		forestModel.addMVC(forestController, forestView);
		forestController.addMVC(forestView, forestModel);
		forestView.addMVC(forestController, forestModel);
